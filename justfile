name := 'cosmic-ext-applet-cargowatch'
export APPID := 'com.vintagetechie.CosmicExtAppletCargoWatch'
...
# Run with debug logs
run-logs *args:
    env RUST_LOG=cosmic_ext_applet_cargowatch=debug RUST_BACKTRACE=full cargo run --release {{args}}
